    ...
    <div className="flex-none hidden lg:block  bg-black h-screen min-w-[25%] fixed ">
      ...
      >
        <div
          title="Github"
          onClick={() =>
            window.open("https://github.com/rodolforsf", "_blank")
          }
        >
        ...
        <div
          ...
          onClick={() =>
            window.open(
              "https://www.linkedin.com/in/rodolfo-rs-faria/",
              "_blank"
            )
          }
        >
